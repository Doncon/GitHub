...
// /help
	...
	$telegram->sendMessage(array('chat_id' => $chat_id, 'text' => "Hoi! Ik ben een bot gemaakt door @Duncan met een beetje hulp en copy pasta werk van andere bots.
Ik sta op Github; https://github.com/Doncon/Fixxbot
